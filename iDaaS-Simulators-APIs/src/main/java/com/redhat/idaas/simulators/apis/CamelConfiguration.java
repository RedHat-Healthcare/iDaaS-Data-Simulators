 ...
 *
 */
package com.redhat.idaas.simulators.apis;
...
public class CamelConfiguration extends RouteBuilder {
  ...
  private String getFHIRUri(String hostID, int port, String fhirBaseAPIPath, String fhirResource) {
    ...
    String fhirServerURI = "jetty://"+hostID+":"+portNumber+"/"+fhirBaseAPIPath+fhirResource+"?bridgeEndpoint=true&exchangePattern=InOut";
    return fhirServerURI;
  }

  private String getFHIRUriDirectory(String dirName) {
  ...
  public void configure() throws Exception {
    ...
    /*
     *  FHIR File to FHIR Servlet URL
     *  It will automatically create the directory for you, you will just need to place files in it
     *
     */
        from(getFHIRUriDirectory(config.fhirClinical_Directory))
            // Auditing
            .routeId("fhirClinicalSimulator")
            .routeDescription("fhirClinicalSimulator")
            .convertBodyTo(String.class)
            .setProperty("processingtype").constant("fhir-sim")
            .setProperty("appname").constant("iDAAS-Simulator-FHIR")
            .setProperty("industrystd").constant("FHIR")
            .setProperty("messagetrigger").constant("clinical")
            ...
            .to(getFHIRUri(config.getFhirHost(),config.getFhirPort(),config.getFhirBaseAPIPath(),
                    config.getFhirResource()))
